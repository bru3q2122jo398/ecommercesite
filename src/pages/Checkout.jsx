                ...
                <div className='md:w-2/3'>
                    <div className='border p-2 mb-6'>
                        <div className='flex items-center justify-between'
                            onClick={() => setShoppingToggle(!shoppingToggle)}>

                            <h3 className='text-lg font-semibold mb-2' >Shopping Information </h3>
                            {shoppingToggle ? <FaAngleDown /> :  <FaAngleUp />}
                        </div>
                        <div className={`space-y-4 ${shoppingToggle ? "" : "hidden"}`}>
                            <div>
                                <label className='block text-gray-700' >Address</label>
                                <input type="text" name="Address" placeholder='Enter Address' 
                                className='w-full px-3 py-2 border' onChange={(e) => setShoppingInfo({...shoppingInfo,address: e.target.value})} />
                            </div>
                        </div>
                        <div>
                            <div>
                                ...
                                onChange={(e) => setShoppingInfo({...shoppingInfo,city: e.target.value})}/>
                            </div>
                        </div>
                        <div>
                            <div>
                                ...
                                onChange={(e) => setShoppingInfo({...shoppingInfo,zip: e.target.value})} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='border p-2 mb-6'>
                        ...
                        {/* <div className='space-y-4'> */}
                            ...
                            {paymentMethod === "dc" && (
                                <div className='block text-gray-700 p-4 rounded-lg mb-4'>
                                    <h3 className='text-xl font-semibold mb-4'>Debit Card Information</h3>
                                    <div className='mb-4'>
                                        <label className='border text-gray-700 font-semibold mb-2'>Card Number</label>
                                        <input type="text" placeholder='Enter Card Number' className='border p-2 w-full rounded' />
                                    </div>
                                    <div className='mb-2'>
                                        <label className='border text-gray-700 font-semibold mb-2' >Card Holder Name</label>
                                        <input type="text" placeholder='Enter Card Holder Number' className='border p-2 w-full rounded' />
                                    </div>
                                    <div className='flex justify-between mb-4'>
                                        <div className='w-1/2 mr-2'>
                                            <label className='block text-gray-700 font-semibold mb-2'>Exprie Date</label>
                                        ...
                                        <div className='w-1/2 ml-2'>
                                            ...
                                            <input type="text" placeholder='CW' className='border p-2 w-full rounded' />
                                        </div>
                                    </div>
                                </div>
                            )}
